        ...
        <>
            ...
            <div class="primary-content-area container content-padding">
                <div class="page-title-section">
                    <h2><span class="gradient-text">Explore</span> Artworks</h2>
                    <div class="display-mode-links">
                ...
                <div class="categories-bar">
                    <div class="categories-nav">
                        <a href="#" class="arrow arrow-left swiper-button-prev"><svg class="crumina-icon"><use xlinkHref="#arrow-left2-icon"></use></svg></a>
                        <a href="#" class="arrow arrow-right swiper-button-next"><svg class="crumina-icon"><use xlinkHref="#arrow-right2-icon"></use></svg></a>
                    </div>
